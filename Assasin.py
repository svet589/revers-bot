...
import os
a = pyfiglet.figlet_format("Assasin", font="univers")
print(Fore.GREEN + a + Style.RESET_ALL)

cprint('(1)---Красивый текст','green')
cprint('(2)---Стили текста','green')
cprint('(3)---Инфа софт','green')
cprint('(4)---Выход!','green')
print('')
while True:
    assosin = input(Fore.GREEN + 'Выберите пункт:' + Style.RESET_ALL)
    if assosin == '1':
        ss = input(Fore.GREEN + 'Введите текст:' + Style.RESET_ALL)
        o = input(Fore.GREEN + 'Введите стиль текста:' + Style.RESET_ALL)
        oo = pyfiglet.figlet_format(ss, font=o)
        print(Fore.GREEN + oo + Style.RESET_ALL)
        input(Fore.GREEN + 'enter' + Style.RESET_ALL)
...
|  / |__/ |__/
     ...
     print(Fore.GREEN +'''
Разраб: @OSjNT
Время за которое был сделан софт: за одну ночь
Даный софт делал на: телефоне
Моё BIO: https://t.me/za_py_BI0
Мой канал основной: https://t.me/+ZDLsSePTiac4MWQ6

Для чего был сделан софт: для того что бы люди могли спокойно и легко сделать банер на свой софт
Количество софтов которых я сделал: 4 |два не удачные а так бы было 6''' + Style.RESET_ALL)
     input(Fore.GREEN + 'enter' + Style.RESET_ALL)
     os.system('cls' if os.name == 'nt' else 'clear')
     a = pyfiglet.figlet_format("Assasin", font="univers")
     print(Fore.GREEN + a + Style.RESET_ALL)
     ...
     print('')
        ...
        print(Fore.GREEN + 'Не корректный вод2' + Style.RESET_ALL)
